...
// it through 10Router to an external chat model makes typing laggy and burns provider quota per
...
function extractModel(url, body) {
  ...
  try {
    ...
    if (cleanModelName === "gemini-3.8-flash-tiered" || cleanModelName === "gemini-3.6-flash-tiered" || cleanModelName === "gemini-3.7-flash-tiered") {
