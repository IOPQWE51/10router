...
const APP_LABEL = "com.10router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when 10router is currently
 ...
 * SIGTERM to the running process. When the running 10router cli.js was itself
...
<dict>
    ...
    <string>/tmp/10router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/10router.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `10router.cmd` lookup that depended on the npm prefix path.
