...
- The **CLI launcher** (`cli/`, published to npm as `10router-cli`) — a separate package that installs/starts the server and manages the tray. It has its own `package.json`, version, and build.
